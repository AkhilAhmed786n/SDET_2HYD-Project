...
public class CreateOpportunitywithSalesStageProposalPriceQuote extends BaseClass {
//	public static void main(String args[]) throws Throwable
	@Test
	public void createOpportunitywithSalesStageProposalPriceQuote() throws Throwable
	{
		
		driver.findElement(By.xpath("//a[@href='index.php?module=Potentials&action=index']")).click();
		driver.findElement(By.xpath("//img[@title='Create Opportunity...']")).click();
		driver.findElement(By.xpath("//input[@name='potentialname']")).sendKeys("Aqheel");
